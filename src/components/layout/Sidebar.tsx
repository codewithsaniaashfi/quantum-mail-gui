...
export function Sidebar({ activeSection, onSectionChange }: SidebarProps) {
  const tooltips = {
    inbox: "View and manage incoming secure emails",
    sent: "See your sent messages and delivery status", 
    drafts: "Continue working on unsaved drafts",
    trash: "Access deleted messages with quantum secure deletion",
    keys: "Monitor and generate quantum encryption keys",
    security: "Real-time security monitoring and threat detection",
    activity: "View comprehensive audit logs of all activities",
    settings: "Configure security preferences and account settings"
  };
      ...
      <div className="w-64 bg-card/30 backdrop-blur-sm border-r border-border/50 h-full flex flex-col">
        ...
        <div className="flex-1 p-4 space-y-6">
              ...
              {mainNavItems.map((item) => (
                <Tooltip key={item.id}>
                  ...
                  <TooltipContent side="right">
                    <p>{tooltips[item.id as keyof typeof tooltips]}</p>
                  </TooltipContent>
                </Tooltip>
              ))}
            </nav>
          ...
          <Tooltip>
            ...
            <TooltipContent side="right">
              <p>Real-time quantum key strength and generation status</p>
            </TooltipContent>
          </Tooltip>
        </div>
        ...
        <div className="p-4 border-t border-border/50">
          <Tooltip>
            ...
            <TooltipContent side="right">
              <p>Configure security preferences and account settings</p>
            </TooltipContent>
          </Tooltip>
        </div>
      </div>
